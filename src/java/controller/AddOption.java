...
public class AddOption extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AddOption</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AddOption at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
            ...
            int pid = Integer.parseInt(request.getParameter("pid"));
            String opdes = request.getParameter("opdes");
            double price = Double.parseDouble(request.getParameter("price"));
            int discount = Integer.parseInt(request.getParameter("discount"));
            Option o =new Option(opdes, price, discount);
            ProductDAO pd = new ProductDAO();
            pd.AutoIdAddOption(o,pid);
